      ...
      <div className="wrap">
        ...
        <div className="grid lg:grid-cols-2 gap-14">
              ...
              {state === "done" ? (
                ...
                <motion.form key="form" onSubmit={submit} className="space-y-4">
                  {[
                    ...
                    <div key={f.id}>
                      <label className="block text-label mb-1.5" style={{ color: "var(--t-muted)" }}>
                        {f.label}
                      </label>
                      <input
                        type={f.type}
          ...
          <div className="cr space-y-8">
            <div>
              <div className="text-label mb-2" style={{ color: "var(--t-muted)" }}>
                Direct Contact
              </div>
              <a
            ...
            <div>
              <div className="text-label mb-4" style={{ color: "var(--t-muted)" }}>
                Find me on
              </div>
            ...
            >
              ...
              <p className="text-xs leading-relaxed" style={{ color: "var(--t-medium)" }}>
